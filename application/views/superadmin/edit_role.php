    ...
    <div class="page-content">
        ...
        <!-- BEGIN PAGE TITLE-->
          <h1 class="page-title"> 
                 ...
                 <div> 
            <a href="<?php echo base_url(); ?>superadmin/role">
                        ...
                        <div class="portlet box green">
                            <div class="portlet-title">
                                ...
                                <div class="portlet-body">
                                 <?php echo form_open_multipart('superadmin/update_role'); ?>
                                        <div class="form-body">
                                            <div class="row">
                                             <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="inputName"></label>
                                                        <input type="hidden" class="form-control" name="role_id" value="<?php echo $role['role_id']; ?>"  required>
                                                        <?php echo form_error('role_id','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo form_error('role_name','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div><!--/row-->
                                            ...
                                            <div class="form-actions right">
                                                ...
                                                <a href="<?php echo base_url(); ?>superadmin/role" class="btn dark" style="margin-right: 80px; "> <i class="fa fa-remove"></i> Cancel</a> 
                                            </div>
                                        </div>
                                        </form> <!-- END FORM-->    
                                </div>
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="portlet-body">
                                     <table class="table table-bordered table-striped" id="sample_3">
                                      ...
                                      <tbody>
                                        <?php if( count($role_records)): ?>
                                        <?php foreach ($role_records as $records ): ?>
                                        <tr>
