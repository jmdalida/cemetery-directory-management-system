...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Add Occupied Lot Information</span>
                </li>
            </ul>
                    ...
                    <div class="tab-pane" id="tab_1">
                        <div class="portlet box green-jungle">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-gift"></i>OCCUPIED LOT FORM</div>
                                    <div class="tools">
                                 ...
                                 <div class="portlet-body form">
                                    <?php echo form_open_multipart('superadmin/extend_deceased_lot'); ?>
                                        <div class="form-body">
                                           <h3 class="form-section">Lot Information </h3>
                                            ...
                                            <div class="form-actions right">
                                                ...
                                                <a href="<?php echo site_url('superadmin/check_extend_deceased/'.$name['occupant_id']); ?>"class="btn dark" style="margin-right: 820px; "> <i class="fa fa-chevron-left"></i> Back</a> 
                                            </div>
                                        </div>
                                    </form> <!-- END FORM-->
                                </div>
   ...
   <!-- BEGIN FOOTER -->
    ...
    legend.onAdd = function(map) {
      ...
      div.innerHTML += '<i style="background: #477AC2"></i><span>Garden</span><br>';
    ...
    $.getJSON(base_url+"pages/map_gardens", function(data) 
    {
       ...
       var polylinePoints_1 = [
        ...
        var polyline = L.polyline(polylinePoints_1).addTo(map); 
