    ...
    .legend i.icon {
      ...
      background-color: rgba(255, 255, 255, 1);
            ...
            <div class="page-content-wrapper">
                ...
                <br>
                <div>
                  <?php if($this->session->flashdata('garden_created')): ?>
                    <?php echo '<div class="custom-alerts alert alert-primary">', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>'.$this->session->flashdata('block_created').'</h4>' ?>
                  <?php endif; ?>

                  <?php if($this->session->flashdata('garden_updated')): ?>
                    <?php echo '<div class="custom-alerts alert alert-success">', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>'.$this->session->flashdata('garden_updated').'</h4>' ?>
                  <?php endif; ?>
                </div>
                ...
                <div class="btn-group">
                    <a  class="btn sbold yellow-gold" href="<?php echo site_url('superadmin/add_garden');?>"> <i class="fa fa-plus"></i> Add New </a>
                </div>
                <br>
                <br>
                <div class="row">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        id="sample_3">
                                            ...
                                            <tbody>
                                                <?php if( count($garden_records)): ?>
                                                <?php foreach ($garden_records as $records ): ?>
                                                <tr>
                                                    <td> <?php echo $records ['garden_name']; ?> </td>
                                                    <td class="clearfix">
                                                        <a class="btn btn-sbold green btn-sm" href="<?php echo site_url('superadmin/edit_garden/'.$records['garden_id']); ?>">
