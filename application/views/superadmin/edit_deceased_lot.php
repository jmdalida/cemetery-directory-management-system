    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Edit Occupied Lot Information</span>
                </li>
            </ul>
                            ...
                            <div class="portlet-title">
                                <div class="caption">
                                 ...
                                 <div class="portlet-body form">
                                    <?php echo form_open_multipart('superadmin/update_deceased_lot'); ?>
                                        <div class="form-body">
                                           <h3 class="form-section">Occupied Lot Information </h3>
                                            <div class="row">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" name="date_avail" value="<?php echo $owner_records['date_avail']; ?>"  required>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        name="owner_lot_id" value="<?php echo $owner_records['owner_lot_id']; ?>" required>
                                                    </div>
                                                </div>
                                            </div><!--/row-->
                                            <br>
