                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <div class="portlet-body">
                                       <form action="<?php echo base_url('superadmin/add_deceased_owner');?>" method="POST">
                                           <h3 class="block" style="color: royalblue;">Provide Personal details</h3>
                                                ...
                                                <h4 style="color: #0080ff;">Birth Place</h4>
                                                <div class="row" style="margin-bottom: 10px;">
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-5" style="margin-bottom: 5px;">Street/Barangay, Municipality, Province:   
                                                            </label>
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="occupant_birthplace" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <h4 style="color: #0080ff;">Death Place</h4>
                                                <div class="row" style="margin-bottom: 10px;">
                                                     <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-5" style="margin-bottom: 5px;">Street/Barangay, Municipality, Province:   
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="occupant_deathplace" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select name="countries_id" class="form-control"  >
                                                                    <?php foreach ( $countries as $countries_name) :?>
                                                                    <option value="<?php echo $countries_name['country_id']; ?>"><?php echo  $countries_name['occupant_country']; ?></option>
                                                                    <?php endforeach; ?>
                                                                    </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <h3 class="block" style="color: royalblue;">Provide Owner Details</h3>
                                                <div class="row" style="margin-bottom: 10px;">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-2" style="margin-bottom: 5px;">Lastname:
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="owner_middlename" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin-bottom: 10px;">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="owner_street&brgy" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="owner_city/municipality" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" name="owner_province" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-2" style="margin-bottom: 5px;">Gender:
                                                                        </label>
                                                            <div class="col-sm-12">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-6" style="margin-bottom: 5px;">Email Address:
                                                            </label>
                                                            <div class="col-sm-12">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                             <label class="control-label col-sm-7" style="margin-bottom: 5px;">Contact Number:
                                                                        </label>
                                                            <div class="col-sm-12">
                                                                <input type="Contact" class="form-control" name="owner_contactno" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="row" style="margin-top: 25px;">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                        <label class="control-label col-md-3">Date Avail:</label>
                                                            <div class="col-md-9">
                                                              <input type="date" name="date_avail" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> 
