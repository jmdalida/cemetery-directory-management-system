...
<div class="page-content-wrapper">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <div class="portlet-body">
                                       <form action="<?php echo base_url('superadmin/add_deceased/'.$owner_id.'/'.$lot_id);?>" method="POST">
                                           <h3 class="block" style="color: royalblue;">Provide Personal Details</h3>
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select name="countries_id" class="form-control"  >
                                                                    ...
                                                                    <option value="<?php echo $countries_name['countries_id']; ?>"><?php echo  $countries_name['occupant_countries']; ?></option>
                                                                    <?php endforeach; ?>
                                                                    </select>
                                                            </div>
                                                        </div>
                                                 ...
                                                 <div class="row" style="margin-bottom: 10px;">
                                                    <div class="col-md-12">
                                                        <div class="form-group"  style="margin-top: 5px;">
                                                            <h4 style="color: #0080ff;">Date Avail</h4>
                                                            <div class="col-md-12">
                                                                <input type="date" class="form-control" name="date_avail"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
   ...
   <!-- BEGIN FOOTER -->
    <div class="page-footer">
        <div class="page-footer-inner" style="background: color;"> Saint Michael Memorial Park
        </div>
