                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            <div class="portlet box yellow-gold">
                                <div class="portlet-title">
                                    ...
                                    <div class="portlet-body">
                                    <?php echo form_open_multipart('superadmin/update_garden'); ?>
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="hidden" class="form-control" name="garden_id" value="<?php echo $garden_records['garden_id']; ?>"  required>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder ="Enter garden name" name="garden_name" value="<?php echo $garden_records['garden_name']; ?>"  required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long1" id="Latitude_1" value="<?php echo $garden_records['garden_long1']; ?>"  readonly> 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  name="garden_lat1" id="Longitude_1" value="<?php echo $garden_records['garden_lat1']; ?>"  readonly> 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control" name="garden_long2" id="Latitude_2" value="<?php echo $garden_records['garden_long2']; ?>"  readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="garden_lat2" id="Longitude_2" value="<?php echo $garden_records['garden_lat2']; ?>"  readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long3" id="Latitude_3" value="<?php echo $garden_records['garden_long3']; ?>"  readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="garden_lat3" id="Longitude_3" value="<?php echo $garden_records['garden_lat3']; ?>"  readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control" name="garden_long4" id="Latitude_4" value="<?php echo $garden_records['garden_long4']; ?>"  readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control"  name="garden_lat4" id="Longitude_4"value="<?php echo $garden_records['garden_lat4']; ?>"  readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control" name="garden_long5" id="Latitude_5"value="<?php echo $garden_records['garden_long5']; ?>"  readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control"  name="garden_lat5" id="Longitude_5" value="<?php echo $garden_records['garden_lat5']; ?>"  readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control" name="garden_long6" id="Latitude_6" value="<?php echo $garden_records['garden_long6']; ?>"   readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="garden_lat6" id="Longitude_6" value="<?php echo $garden_records['garden_lat6']; ?>"   readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long7"  id="Latitude_7"value="<?php echo $garden_records['garden_long7']; ?>"   readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control"  name="garden_lat7"  id="Longitude_7"value="<?php echo $garden_records['garden_lat7']; ?>"   readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control" name="garden_long8" id="Latitude_8"value="<?php echo $garden_records['garden_long8']; ?>"   readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="garden_lat8" id="Longitude_8" value="<?php echo $garden_records['garden_lat8']; ?>"   readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long9" id="Latitude_9"value="<?php echo $garden_records['garden_long9']; ?>"  readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control"  name="garden_lat9" id="Longitude_9" value="<?php echo $garden_records['garden_lat9']; ?>"   readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long10" id="Latitude_10" value="<?php echo $garden_records['garden_long10']; ?>"   readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control"  name="garden_lat10" id="Longitude_10"value="<?php echo $garden_records['garden_lat10']; ?>"   readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long11" id="Latitude_11"value="<?php echo $garden_records['garden_long11']; ?>"   readonly>  
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="garden_lat11" id="Longitude_11"value="<?php echo $garden_records['garden_lat11']; ?>"   readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long12" id="Latitude_12" value="<?php echo $garden_records['garden_long12']; ?>"   readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="garden_lat12" id="Longitude_12" value="<?php echo $garden_records['garden_lat12']; ?>"  readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control" name="garden_long13"id="Latitude_13" value="<?php echo $garden_records['garden_long13']; ?>"  readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="garden_lat13"  id="Longitude_13" value="<?php echo $garden_records['garden_lat13']; ?>"  readonly>  
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long14" id="Latitude_14"value="<?php echo $garden_records['garden_long14']; ?>" readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control"  name="garden_lat14" id="Longitude_14"value="<?php echo $garden_records['garden_lat14']; ?>"  readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long15" id="Latitude_15" value="<?php echo $garden_records['garden_long15']; ?>"  readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control"  name="garden_lat15" id="Longitude_15" value="<?php echo $garden_records['garden_lat15']; ?>"  readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="garden_long16" id="Latitude_16"value="<?php echo $garden_records['garden_long16']; ?>"  readonly> 
                                                        <?php echo form_error('contactno','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="garden_lat16" id="Longitude_16"value="<?php echo $garden_records['garden_lat16']; ?>"  readonly> 
                                                        <?php echo form_error('address','<div class="text-danger">'); ?>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="form-actions right">
                                                <button type="submit" class="btn yellow-gold" style="float: right;"> <i class="fa fa-check"></i> Save</button>
