                            ...
                            <div class="portlet-title">
                                <div class="caption">
                                 ...
                                 <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <?php echo form_open_multipart('superadmin/update_owner_transfer'); ?>
                                        <div class="form-body">
                                            ...
                                            <div class="form-actions right">
                                                <button type="submit" class="btn green" style="float: right;"><i class="fa fa-check"></i>  Save </i></button>
                                                <a href="<?php echo site_url('superadmin/view_deceased'); ?>" class="btn dark" style="margin-right: 820px; "> <i class="fa fa-remove"></i> Cancel</a> 
