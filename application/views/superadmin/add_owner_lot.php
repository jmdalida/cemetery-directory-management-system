  ...
  <style type="text/css">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="portlet box green-jungle">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-plus"></i>Reserved Lot</div>
                                </div>  
                                <div class="portlet-body">
                                       <form action="<?php echo base_url('superadmin/add_owner_lot');?>" method="POST">
                                                <h3 class="block" style="color: limegreen;">Provide Personal details</h3>
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-5" style="margin-bottom: 5px;">Date Avail:
                                                            </label>
                                                            <div class="col-sm-12">
                                                                <input type="Date" class="form-control" name="date_avail" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <h3 class="block" style="color: limegreen;">Provide Lot Details</h3>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-offset-5 col-md-4">
                                                            <button type="submit" class="btn green-jungle" value="submit">Submit</button>
   ...
   <!-- BEGIN FOOTER -->
    <div class="page-footer">
        <div class="page-footer-inner" style="color: green;"> Saint Michael Memorial Park
        </div>
