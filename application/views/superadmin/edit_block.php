                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            <div class="portlet box green-jungle">
                                <div class="portlet-title">
                                    ...
                                    <div class="portlet-body">
                                    <?php echo form_open_multipart('superadmin/update_block'); ?>
                                        <div class="form-body">
                                            <div class="row">
                                                 <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="inputName"></label>
                                                        <input type="hidden" class="form-control" name="block_id" value="<?php echo $block_records['block_id']; ?>" required>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-12">
                                                ...
                                                <!--/span-->
                                                 <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder ="Enter block name" name="block_name" value="<?php echo $block_records['block_name']; ?>" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="block_long1" id="Latitude_1" value="<?php echo $block_records['block_long1']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  name="block_lat1" id="Longitude_1" value="<?php echo $block_records['block_lat1']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div><!--/row-->
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control" name="block_long2" id="Latitude_2" value="<?php echo $block_records['block_long2']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="block_lat2" id="Longitude_2" value="<?php echo $block_records['block_lat2']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div><!--/row-->
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control"  name="block_long3" id="Latitude_3" value="<?php echo $block_records['block_long3']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control" name="block_lat3" id="Longitude_3" value="<?php echo $block_records['block_lat3']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div><!--/row-->
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       <label for="inputName">Latitude</label>
                                                        <input type="text" class="form-control" name="block_long4" id="Latitude_4" value="<?php echo $block_records['block_long4']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputName">Longitude</label>
                                                        <input type="text" class="form-control"  name="block_lat4" id="Longitude_4" value="<?php echo $block_records['block_lat4']; ?>" readonly>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div><!--/row-->
                                            ...
                                            <div class="form-actions right">
                                                <button type="submit" class="btn green-jungle" style="float: right;"> <i class="fa fa-check"></i> Save</button>
