        <!--[if lt IE 9]>
<script src="<?php echo base_url();?>admin_template/assets/global/plugins/respond.min.js"></script>
<script src="<?php echo base_url();?>admin_template/assets/global/plugins/excanvas.min.js"></script> 
<script src="<?php echo base_url();?>admin_template/assets/global/plugins/ie8.fix.min.js"></script> 
<![endif]-->
        <!-- BEGIN CORE PLUGINS -->
        ...
        <script src="<?php echo base_url();?>admin_template/assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url();?>admin_template/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url();?>admin_template/assets/pages/scripts/login-4.min.js" type="text/javascript"></script>
