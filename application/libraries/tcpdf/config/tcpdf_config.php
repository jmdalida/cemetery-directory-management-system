 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'NTC'); //TCPDF

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'NTC'); //TCPDF

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', "NATIONAL TELECOMMUNICATION COMMISSION"); //TCPDF Example

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Republic of the Philippines\nRegional Office No. 10, Kauswagan, Cagayan de Oro City\nROC Amateur License Log Report Generator");
